...
const Testimonials = () => {
  return (
<div className="my-20 md:px-6 mx-4 md:mx-auto">
  <section className="text-center">
    <div className='my-6'>
    <Heading subHeading={"Testinomials"} heading={"What people say"} desc={"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam luctus commodo velit, id efficitur purus condimentum nec. Phasellus velit."} />

    </div>

    <div className="grid gap-4 md:gap-6 md:grid-cols-3 xl:gap-x-12">
      <div className="mb-6 lg:mb-0">
        <div
          className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] p-4">
          <div className="flex">
            <div
              className="relative w-full overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]"
      ...
      <div className="mb-6 lg:mb-0">
        <div
          className="relative block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] p-4">
          <div className="flex">
            <div
              className="relative w-full overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]"
              data-te-ripple-init data-te-ripple-color="light">
