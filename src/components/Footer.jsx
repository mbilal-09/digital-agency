                ...
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link href="/" className="flex items-center">
                            <img src="/next.svg" className="h-8 me-3" alt="Logo" />
                        </Link>
                        <p className='sm:w-3/4 md:w-2/3 lg:w-1/3 mt-6 text-gray-500 text-sm'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam luctus commodo velit, id efficitur purus condimentum nec. Phasellus velit.</p>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                ...
                                <li className="mb-2">
                                    <Link href="/About" className="hover:text-[--primary]">Services</Link>
                                </li>
                                <li className="mb-2">
                                    <Link href="/About" className="hover:text-[--primary]">Projects</Link>
                                </li>
                                <li className="mb-2">
